...
protected:
   ...
   const double m_minImprovement;   ///< improvement nesseccary to carry on.
   const double m_goodEnoughRatio;  ///< no scaling needed if ratio is less than this.
   //@}
...
public:
   ...
   explicit SPxGeometSC(int maxIters = 8, double minImpr = 0.85, double goodEnough = 1e3);
   /// copy constructor
