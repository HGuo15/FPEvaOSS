...
void SPxSteepPR::setupPrefs(SPxSolver::Type tp)
{
   if (tp != prefSetup)
   {
      double mult = 1e-8 / Real(1 + thesolver->dim() + thesolver->coDim());
...
void SPxSteepPR::left4(int n, SPxId id)
{
   ...
   if (id.isValid())
   {
      ...
      double        rhov_1        = 1.0 / rhoVec[n];
      double        beta_q        = thesolver->coPvec().delta().length2() * rhov_1 * rhov_1;
...
int SPxSteepPR::buildBestPriceVectorLeave( double feastol )
{
   int idx;
   int nsorted;
   double x;
   ...
   const double* prefPtr = leavePref.get_const_ptr();
   IdxElement price;
   prices.clear();
   bestPrices.clear();
...
int SPxSteepPR::selectLeaveX(double tol)
{
...
int SPxSteepPR::selectLeaveSparse(double tol)
{
   const double* coPenalty_ptr = coPenalty.get_const_ptr();
   const double* fTest         = thesolver->fTest().get_const_ptr();
   const double* p             = leavePref.get_const_ptr();
...
int SPxSteepPR::selectLeaveHyper(double tol)
{
   const double* coPen = coPenalty.get_const_ptr();
   const double* fTest = thesolver->fTest().get_const_ptr();
   const double* prefPtr  = leavePref.get_const_ptr();

   double leastBest = infinity;
   double best = -infinity;
   double x;
...
SPxId SPxSteepPR::buildBestPriceVectorEnterDim( double& best, double feastol )
{
...
SPxId SPxSteepPR::buildBestPriceVectorEnterCoDim( double& best, double feastol )
{
...
SPxId SPxSteepPR::selectEnterX(double tol)
{
   SPxId enterId;
   SPxId enterCoId;
   double best;
...
SPxId SPxSteepPR::selectEnterHyperDim(double& best, double tol)
{
   const double* cp            = coPref.get_const_ptr();
   const double* coTest        = thesolver->coTest().get_const_ptr();
   const double* coPenalty_ptr = coPenalty.get_const_ptr();
...
SPxId SPxSteepPR::selectEnterHyperCoDim(double& best, double tol)
{
   const double* p           = pref.get_const_ptr();
   const double* test        = thesolver->test().get_const_ptr();
   const double* penalty_ptr = penalty.get_const_ptr();
...
SPxId SPxSteepPR::selectEnterSparseDim(double& best, double tol)
{
   SPxId enterId;
   const double* cp            = coPref.get_const_ptr();
   const double* coTest        = thesolver->coTest().get_const_ptr();
...
SPxId SPxSteepPR::selectEnterSparseCoDim(double& best, double tol)
{
   SPxId enterId;
   const double* p             = pref.get_const_ptr();
   const double* test          = thesolver->test().get_const_ptr();
...
SPxId SPxSteepPR::selectEnterDenseDim(double& best, double tol)
{
   SPxId enterId;
   const double* cp            = coPref.get_const_ptr();
   const double* coTest        = thesolver->coTest().get_const_ptr();
...
SPxId SPxSteepPR::selectEnterDenseCoDim(double& best, double tol)
{
   SPxId enterId;
   const double* p             = pref.get_const_ptr();
   const double* test          = thesolver->test().get_const_ptr();
