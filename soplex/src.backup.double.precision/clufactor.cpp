 ...
 */
void CLUFactor::initFactorMatrix( const SVector** vec, const double eps )
{
...
void CLUFactor::selectPivots( double threshold )
{
   ...
   int beg;
   double l_maxabs;
   double x = REAL( 0.0 ); // This value should never be used.
   int mkwtz;
   int candidates;
...
void CLUFactor::solveUright( double* wrk, double* vec ) const
{
...
void CLUFactor::solveLleft( double* vec ) const
{
...
int CLUFactor::vSolveRight4update3( double eps,
                                    double* vec, int* idx,                 /* result1 */
                                    double* rhs, int* ridx, int rn,        /* rhs1    */
                                    double* vec2, double eps2,               /* result2 */
                                    double* rhs2, int* ridx2, int rn2,     /* rhs2    */
...
int CLUFactor::vSolveLeft3( double eps,
                            double* vec, int* idx,                      /* result */
                            double* rhs, int* ridx, int rn,             /* rhs    */
                            double* vec2,                               /* result2 */
                            double* rhs2, int* ridx2, int rn2,          /* rhs2    */
