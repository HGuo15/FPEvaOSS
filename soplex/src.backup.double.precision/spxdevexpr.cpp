...
int SPxDevexPR::buildBestPriceVectorLeave( double feastol )
{
   int idx;
   int nsorted;
   double fTesti;
...
int SPxDevexPR::selectLeaveX(double feastol, int start, int incr)
{
   double x;
...
int SPxDevexPR::selectLeaveSparse(double feastol)
{
   double x;
...
int SPxDevexPR::selectLeaveHyper(double feastol)
{
   double x;
...
SPxId SPxDevexPR::buildBestPriceVectorEnterDim( double& best, double feastol )
{
   int idx;
   int nsorted;
   double x;
...
SPxId SPxDevexPR::buildBestPriceVectorEnterCoDim( double& best, double feastol )
{
   int idx;
   int nsorted;
   double x;
...
SPxId SPxDevexPR::selectEnterX(double tol)
{
   SPxId enterId;
   SPxId enterCoId;
   double best;
...
SPxId SPxDevexPR::selectEnterHyperDim(double& best, double feastol)
{
...
SPxId SPxDevexPR::selectEnterHyperCoDim(double& best, double feastol)
{
   const double* test = thesolver->test().get_const_ptr();
   const double* pen = penalty.get_const_ptr();
   double leastBest = infinity;
...
SPxId SPxDevexPR::selectEnterSparseDim(double& best, double feastol)
{
   const double* cTest = thesolver->coTest().get_const_ptr();
   const double* cpen = coPenalty.get_const_ptr();
   int enterIdx = -1;
...
SPxId SPxDevexPR::selectEnterSparseCoDim(double& best, double feastol)
{
   const double* test = thesolver->test().get_const_ptr();
   const double* pen = penalty.get_const_ptr();
   int enterIdx = -1;
...
SPxId SPxDevexPR::selectEnterDenseDim(double& best, double feastol, int start, int incr)
{
   const double* cTest = thesolver->coTest().get_const_ptr();
   const double* cpen = coPenalty.get_const_ptr();
   int end = coPenalty.dim();
...
SPxId SPxDevexPR::selectEnterDenseCoDim(double& best, double feastol, int start, int incr)
{
   const double* test = thesolver->test().get_const_ptr();
   const double* pen = penalty.get_const_ptr();
   int end = penalty.dim();
