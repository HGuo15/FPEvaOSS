...
private:
   ...
   int selectLeaveX(double feastol, int start = 0, int incr = 1);
   /// implementation of sparse pricing in the leaving Simplex
   int selectLeaveSparse(double feastol);
   /// implementation of hyper sparse pricing in the leaving Simplex
   int selectLeaveHyper(double feastol);
   ...
   SPxId selectEnterSparseDim(double& best, double feastol);
   /// implementation of sparse pricing in the entering Simplex
   SPxId selectEnterSparseCoDim(double& best, double feastol);
   /// SPxPricer::selectEnter() in dense case (slack variabels)
   SPxId selectEnterDenseDim(double& best, double feastol, int start = 0, int incr = 1);
   /// SPxPricer::selectEnter() in dense case
   SPxId selectEnterDenseCoDim(double& best, double feastol, int start = 0, int incr = 1);
