...
private:
   ...
   SPxId                 selectEnterSparseDim(double& best,SPxId& id);    /**< sparse pricing method for entering Simplex (slack variables)*/
   SPxId                 selectEnterSparseCoDim(double& best, SPxId& id); /**< sparse pricing method for entering Simplex */
   SPxId                 selectEnterDenseDim(double& best, SPxId& id);    /**< selectEnter() in dense case (slack variables) */
   SPxId                 selectEnterDenseCoDim(double& best,SPxId& id);   /**< selectEnter() in dense case */
public:
