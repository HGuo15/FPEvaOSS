...
public:
   ...
   /// return time limit.
   inline double terminationTime() const
   {
   ...
   /// set objective limit.
   virtual void setTerminationValue(double val = infinity)
   {
      m_solver.setTerminationValue(val);
   }
   /// return objective limit.
   inline double terminationValue() const
   {
      return m_solver.terminationValue();
   }
   /// allowed primal feasibility tolerance.
   virtual double feastol() const
   {
      return m_solver.feastol();
   }
   /// allowed optimality, i.e., dual feasibility tolerance.
   virtual double opttol() const
   {
   ...
   virtual double getFactorTime() const
   {
   ...
   virtual double getSolveTime() const
   {
