...
protected:
   ...
   DataArray < double > m_colscale;  ///< column scaling factors
   DataArray < double > m_rowscale;  ///< row scaling factors
   ...
   virtual double computeScale(double mini, double maxi) const;
    ...
    */
   virtual double computeScalingVecs( const SVSet* vecset, 
                                    const DataArray<double>& coScaleval, 
                                    DataArray<double>& scaleval );
...
public:
   ...
   virtual double minAbsColscale() const;
   /// absolute biggest column scaling factor
   virtual double maxAbsColscale() const;
   /// absolute smallest row scaling factor
   virtual double minAbsRowscale() const;
   /// absolute biggest row scaling factor
   virtual double maxAbsRowscale() const;
   /// maximum ratio between absolute biggest and smallest element in any column.
   virtual double maxColRatio(const SPxLP& lp) const;
   /// maximum ratio between absolute biggest and smallest element in any row.
   virtual double maxRowRatio(const SPxLP& lp) const;
   //@}
