...
void checkSolutionReal(SoPlex& soplex)
{
   if( soplex.hasPrimal() )
   {
      ...
      {
         MSG_INFO1(
            double maxviol = boundviol > rowviol ? boundviol : rowviol;
   ...
   if( soplex.hasDual() )
   {
      ...
      {
         MSG_INFO1(
            double maxviol = redcostviol > dualviol ? redcostviol : dualviol;
...
int main(int argc, char* argv[])
{
   ...
   try {
      ...
      double                      delta          = DEFAULT_BND_VIOL;
      double                      feastol        = DEFAULT_BND_VIOL;
      double                      opttol         = DEFAULT_BND_VIOL;
      double                      epsilon        = DEFAULT_EPS_ZERO;
      double                      epsilon_factor = DEFAULT_EPS_FACTOR;
      double                      epsilon_update = DEFAULT_EPS_UPDATE;
