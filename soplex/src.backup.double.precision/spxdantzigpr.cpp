...
SPxId SPxDantzigPR::selectEnterSparseDim(double& best,SPxId& enterId)
{
   assert(thesolver != 0);
...
SPxId SPxDantzigPR::selectEnterSparseCoDim(double& best,SPxId& enterId)
{
   assert(thesolver != 0);
...
SPxId SPxDantzigPR::selectEnterDenseDim(double& best,SPxId& enterId)
{
   assert(thesolver != 0);
...
SPxId SPxDantzigPR::selectEnterDenseCoDim(double& best,SPxId& enterId)
{
   assert(thesolver != 0);
