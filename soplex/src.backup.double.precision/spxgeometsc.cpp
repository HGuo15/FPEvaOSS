...
*/ 
SPxGeometSC::SPxGeometSC(int maxIters, double minImpr, double goodEnough)
   : SPxScaler("Geometric")
...
double SPxGeometSC::computeScale(double mini, double maxi) const
{
...
void SPxGeometSC::scale(SPxLP& lp) 
{
    ...
    */
   double colratio = maxColRatio(lp);
   double rowratio = maxRowRatio(lp);
