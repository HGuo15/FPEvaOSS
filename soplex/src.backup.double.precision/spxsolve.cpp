...
bool SPxSolver::precisionReached(double& newpricertol) const
{
...
SPxSolver::Status SPxSolver::solve()
{
   ...
   while (!stop)
   {
      ...
      if (type() == ENTER)
      {
          ...
          */
         double maxpricertol = leavetol();
         double minpricertol = 0.01 * maxpricertol;
         ...
         do
         {
            ...
            if (!enterId.isValid())
            {
               ...
               {
                  double newpricertol = minpricertol;
