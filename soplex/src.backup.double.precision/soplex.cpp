...
namespace soplex
{
   ...
   public:
      ...
      static double _realParamDefault[SoPlex::REALPARAM_COUNT];
      ...
      static double _realParamLower[SoPlex::REALPARAM_COUNT];

      /// array of upper bounds for real parameter values
      static double _realParamUpper[SoPlex::REALPARAM_COUNT];
      ...
      double _realParamValues[SoPlex::REALPARAM_COUNT];
      ...
      Settings()
      {
         if( !_defaultsAndBoundsInitialized )
         {
            ...
            ///@todo define suitable values depending on double type
   ...
   double SoPlex::Settings::_realParamLower[SoPlex::REALPARAM_COUNT];
   double SoPlex::Settings::_realParamUpper[SoPlex::REALPARAM_COUNT];
   double SoPlex::Settings::_realParamDefault[SoPlex::REALPARAM_COUNT];
   ...
   double SoPlex::minAbsNonzeroReal() const
   {
      assert(_realLP != 0);
   ...
   double SoPlex::maxAbsNonzeroReal() const
   {
      assert(_realLP != 0);
   ...
   double SoPlex::rhsReal(int i) const
   {
      assert(_realLP != 0);
   ...
   double SoPlex::lhsReal(int i) const
   {
      assert(_realLP != 0);
   ...
   double SoPlex::upperReal(int i) const
   {
      assert(_realLP != 0);
   ...
   double SoPlex::lowerReal(int i) const
   {
      assert(_realLP != 0);
   ...
   double SoPlex::objReal(int i) const
   {
      assert(_realLP != 0);
   ...
   double SoPlex::maxObjReal(int i) const
   {
      assert(_realLP != 0);
   ...
   void SoPlex::changeLhsReal(int i, const double& lhs)
   {
      assert(_realLP != 0);
   ...
   void SoPlex::changeRhsReal(int i, const double& rhs)
   {
      assert(_realLP != 0);
   ...
   void SoPlex::changeRangeReal(int i, const double& lhs, const double& rhs)
   {
      assert(_realLP != 0);
   ...
   void SoPlex::changeLowerReal(int i, const double& lower)
   {
      assert(_realLP != 0);
   ...
   void SoPlex::changeUpperReal(int i, const double& upper)
   {
      assert(_realLP != 0);
   ...
   void SoPlex::changeBoundsReal(int i, const double& lower, const double& upper)
   {
      assert(_realLP != 0);
   ...
   void SoPlex::changeObjReal(int i, const double& obj)
   {
      assert(_realLP != 0);
   ...
   void SoPlex::changeElementReal(int i, int j, const double& val)
   {
      assert(_realLP != 0);
   ...
   bool SoPlex::getBoundViolationReal(double& maxviol, double& sumviol)
   {
      if( !hasPrimal() )
         return false;
      ...
      {
         double viol = lowerReal(i) - primal[i];
         if( viol > 0.0 )
         {
            sumviol += viol;
            if( viol > maxviol )
   ...
   bool SoPlex::getRowViolationReal(double& maxviol, double& sumviol)
   {
      if( !hasPrimal() )
         return false;
      ...
      {
         double viol = lhsReal(i) - activity[i];
         if( viol > 0.0 )
         {
            sumviol += viol;
            if( viol > maxviol )
   ...
   bool SoPlex::getRedCostViolationReal(double& maxviol, double& sumviol)
   {
      if( !hasDual() || !hasBasis() )
         return false;
   ...
   bool SoPlex::getDualViolationReal(double& maxviol, double& sumviol)
   {
      if( !hasDual() || !hasBasis() )
         return false;
   ...
   bool SoPlex::getEstimatedCondition(double& condition)
   {
      _ensureRealLPLoaded();
      if( !_isRealLPLoaded )
         return false;
   ...
   bool SoPlex::getExactCondition(double& condition)
   {
      _ensureRealLPLoaded();
      if( !_isRealLPLoaded )
         return false;
   ...
   bool SoPlex::getBasisInverseRowReal(int r, double* coef)
   {
      assert(r >= 0);
      ...
      else
      {
         ...
         memset(coef, 0, (unsigned int)numRowsReal() * sizeof(double));
   ...
   bool SoPlex::getBasisInverseColReal(int c, double* coef)
   {
      assert(c >= 0);
   ...
   bool SoPlex::getBasisInverseTimesVecReal(double* rhs, double* sol)
   {
   ...
   double SoPlex::realParam(const RealParam param) const
   {
      assert(param >= 0);
   ...
   bool SoPlex::setRealParam(const RealParam param, const double value, const bool quiet, const bool init)
   {
      assert(param >= 0);
      assert(param < REALPARAM_COUNT);
      assert(init || _isConsistent());
   ...
   void SoPlex::printVersion() const
   {
      ...
      MSG_INFO1( spxout << " [precision: " << (int)sizeof(double) << " byte]" );
   ...
   bool SoPlex::areLPsInSync(const bool checkVecVals, const bool checkMatVals, const bool quiet) const
   {
      ...
      {
         MSG_ERROR( spxout << "The number of Rows in the double LP does not match the one in the Rational LP."
               << " double LP: " << _realLP->nRows() << "  Rational LP: " << _rationalLP->nRows() << std::endl);
         result = false;
         nRowsMatch = false;
      }
      ...
      {
         MSG_ERROR( spxout << "The number of Columns in the double LP does not match the one in the Rational LP."
               << " double LP: " << _realLP->nCols() << "  Rational LP: " << _rationalLP->nCols() << std::endl);
         result = false;
         nColsMatch = false;
      }
      ...
      {
         MSG_ERROR( spxout << "The number of nonZeros in the double LP does not match the one in the Rational LP."
               << " double LP: " << _realLP->nNzos() << "  Rational LP: " << _rationalLP->nNzos() << std::endl);
         result = false;
      }
      ...
      {
         MSG_ERROR( spxout << "The dimension of the right hand side vector of the double LP does not match the one of the Rational LP."
               << " double LP: " << _realLP->rhs().dim() << "  Rational LP: " << _rationalLP->rhs().dim() << std::endl);
         result = false;
         rhsDimMatch = false;
      ...
      {
         MSG_ERROR( spxout << "The dimension of the left hand side vector of the double LP does not match the one of the Rational LP."
               << " double LP: " << _realLP->lhs().dim() << "  Rational LP: " << _rationalLP->lhs().dim() << std::endl);
         result = false;
         lhsDimMatch = false;
      }
      ...
      {
         MSG_ERROR( spxout << "The dimension of the objective function vector of the double LP does not match the one of the Rational LP."
               << " double LP: " << _realLP->maxObj().dim() << "  Rational LP: " << _rationalLP->maxObj().dim() << std::endl);
         result = false;
      ...
      if( (int)_realLP->spxSense() != (int)_rationalLP->spxSense() )
         {
            MSG_ERROR( spxout << "The objective function sense of the double LP does not match the one of the Rational LP."
               << " double LP: " << (_realLP->spxSense() == SPxLPReal::MINIMIZE ? "MIN" : "MAX")
      ...
      {
         MSG_ERROR( spxout << "The dimension of the upper bound vector of the double LP does not match the one of the Rational LP."
               << " double LP: " << _realLP->upper().dim() << "  Rational LP: " << _rationalLP->upper().dim() << std::endl);
         result = false;
         upperDimMatch = false;
      }
      ...
      {
         MSG_ERROR( spxout << "The dimension of the lower bound vector of the double LP does not match the one of the Rational LP."
               << " double LP: " << _realLP->lower().dim() << "  Rational LP: " << _rationalLP->lower().dim() << std::endl);
         result = false;
         lowerDimMatch = false;
      }
                     ...
                     && !_rationalLP->rhs()[i].isAdjacentTo(_realLP->rhs()[i])) )
               {
                  if( !quiet )
                  {
                     MSG_ERROR( spxout << "Entries number " << i << " of the right hand side vectors don't match."
                           << " double LP: " << _realLP->rhs()[i] << "  Rational LP: " << _rationalLP->rhs()[i] << std::endl);
                  }
                  rhsValMatch = false;
                  result = false;
               }
                     ...
                     && !_rationalLP->lhs()[i].isAdjacentTo(_realLP->lhs()[i])) )
               {
                  if( !quiet )
                  {
                     MSG_ERROR( spxout << "Entries number " << i << " of the left hand side vectors don't match."
                           << " double LP: " << _realLP->lhs()[i] << "  Rational LP: " << _rationalLP->lhs()[i] << std::endl);
                  }
                  lhsValMatch = false;
                  result = false;
               }
               ...
               if( !_rationalLP->maxObj()[i].isAdjacentTo(_realLP->maxObj()[i]) )
               {
                  if( !quiet )
                  {
                     MSG_ERROR( spxout << "Entries number " << i << " of the objective function vectors don't match."
                           << " double LP: " << _realLP->maxObj()[i] << "  Rational LP: " << _rationalLP->maxObj()[i] << std::endl);
                  }
                     ...
                     && !_rationalLP->upper()[i].isAdjacentTo(_realLP->upper()[i])) )
               {
                  if( !quiet )
                  {
                     MSG_ERROR( spxout << "Entries number " << i << " of the upper bound vectors don't match."
                           << " double LP: " << _realLP->upper()[i] << "  Rational LP: " << _rationalLP->upper()[i] << std::endl);
                  }
                  upperValMatch = false;
                  result = false;
               }
                     ...
                     && !_rationalLP->lower()[i].isAdjacentTo(_realLP->lower()[i])) )
               {
                  if( !quiet )
                  {
                     MSG_ERROR( spxout << "Entries number " << i << " of the lower bound vectors don't match."
                           << " double LP: " << _realLP->lower()[i] << "  Rational LP: " << _rationalLP->lower()[i] << std::endl);
                  }
                  lowerValMatch = false;
                  result = false;
               }
               ...
               if( !_rationalLP->colVector(i)[j].isAdjacentTo(_realLP->colVector(i)[j]) )
               {
                  if( !quiet )
                  {
                     MSG_ERROR( spxout << "Entries number " << j << " of column number " << i << " don't match."
                           << " double LP: " << _realLP->colVector(i)[j] << "  Rational LP: " << _rationalLP->colVector(i)[j] << std::endl);
                  }
   ...
   void SoPlex::_changeLhsReal(int i, const double& lhs)
   {
      assert(_realLP != 0);
   ...
   void SoPlex::_changeRhsReal(int i, const double& rhs)
   {
      assert(_realLP != 0);
   ...
   void SoPlex::_changeRangeReal(int i, const double& lhs, const double& rhs)
   {
      assert(_realLP != 0);
   ...
   void SoPlex::_changeLowerReal(int i, const double& lower)
   {
      assert(_realLP != 0);
   ...
   void SoPlex::_changeUpperReal(int i, const double& upper)
   {
      assert(_realLP != 0);
   ...
   void SoPlex::_changeBoundsReal(int i, const double& lower, const double& upper)
   {
      assert(_realLP != 0);
   ...
   void SoPlex::_changeElementReal(int i, int j, const double& val)
   {
      assert(_realLP != 0);
