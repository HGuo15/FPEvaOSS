...
void SPxSolver::changeObj(int i, const double& newVal)
{
...
void SPxSolver::changeLower(int i, const double& newLower)
{
...
void SPxSolver::changeUpper(int i, const double& newUpper)
{
...
void SPxSolver::changeBounds(int i, const double& newLower, const double& newUpper)
{
...
void SPxSolver::changeLhs(int i, const double& newLhs)
{
...
void SPxSolver::changeRhs(int i, const double& newRhs)
{
...
void SPxSolver::changeRange(int i, const double& newLhs, const double& newRhs)
{
...
void SPxSolver::changeElement(int i, int j, const double& val)
{
