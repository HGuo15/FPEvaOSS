...
void SPxSolver::qualConstraintViolation(double& maxviol, double& sumviol) const
{
   maxviol = 0.0;
   sumviol = 0.0;
...
void SPxSolver::qualSlackViolation(double& maxviol, double& sumviol) const
{
   maxviol = 0.0;
   sumviol = 0.0;
...
void SPxSolver::qualRedCostViolation(double& maxviol, double& sumviol) const
{   
   maxviol = 0.0;
   sumviol = 0.0;
