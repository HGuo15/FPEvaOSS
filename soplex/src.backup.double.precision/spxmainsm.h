...
private:
   ...
   */
   ...
   private:
      ...
      const double m_obj;
      DSVector   m_col;
      const double m_newLo;
      const double m_newUp;
      const double m_oldLo;
      const double m_oldUp;

   public:
      ///
      RowSingletonPS(const SPxLP& lp, int _i, int _j, bool strictLo, bool strictUp,
                     double newLo, double newUp, double oldLo, double oldUp)
   ...
   */
   ...
   private:
      ...
      const double      m_lRhs;
      DSVector        m_row;
      DataArray<double> m_objs;
      DataArray<bool> m_fixed;
      Array<DSVector> m_cols;
      const bool      m_lhsFixed;
      const bool      m_maxSense;
      DataArray<double> m_oldLowers;
      DataArray<double> m_oldUppers;
      const double      m_lhs;
      const double      m_rhs;

   public:
      ///
      ForceConstraintPS(const SPxLP& lp, int _i, bool lhsFixed, DataArray<bool>& fixCols, DataArray<double>& lo, DataArray<double>& up)
   ...
   */
   ...
   public:
      ///
      FixVariablePS(const SPxLP& lp, SPxMainSM& simplifier, int _j, const double val, bool correctIdx = true)
   ...
   */
   ...
   public:
      ///
      FixBoundsPS(const SPxLP& lp, int j, double val)
   ...
   */
   ...
   public:
      ///
      FreeColSingletonPS(const SPxLP& lp, SPxMainSM& simplifier, int _j, int _i, double slackVal)
   ...
   */
   ...
   public:
      ///
      DoubletonEquationPS(const SPxLP& lp, int _j, int _k, int _i, double oldLo, double oldUp)
   ...
   */
   ...
   public:
      DuplicateColsPS(const SPxLP& lp, int _j, int _k, double scale, DataArray<int>  perm, bool isFirst = false, bool isTheLast = false)
...
private:
   ...
   double                            m_epsilon;    ///< epsilon zero.
   double                            m_feastol;    ///< primal feasibility tolerance.
   double                            m_opttol;     ///< dual feasibility tolerance.
...
public:
   ...
   virtual Result simplify(SPxLP& lp, double eps, double delta)
   {
      return simplify(lp, eps, delta, delta);
   }
   /// simplify SPxLP \p lp with independent primal and dual feasibility tolerance.
   virtual Result simplify(SPxLP& lp, double eps, double ftol, double otol, bool keepbounds = false);
