 ...
 */
double SPxScaler::computeScale(double /*mini*/, double /*maxi*/) const
{

   return 1.0;
}

double SPxScaler::computeScalingVecs(
   const SVSet*           vecset, 
   ...
   DataArray<double>&       scaleval) 
{
   ...
   for(int i = 0; i < vecset->num(); ++i )
   {
      ...
      {
         double x = fabs(vec.value(j) * coScaleval[vec.index(j)]);
...
double SPxScaler::minAbsColscale() const
{
...
double SPxScaler::maxAbsColscale() const
{
...
double SPxScaler::minAbsRowscale() const
{
...
double SPxScaler::maxAbsRowscale() const
{
 ...
 */
double SPxScaler::maxColRatio(const SPxLP& lp) const
{
 ...
 */
double SPxScaler::maxRowRatio(const SPxLP& lp) const
{
