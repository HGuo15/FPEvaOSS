...
public:
   ...
   double minAbsNonzeroReal() const;

   /// returns biggest non-zero element in absolute value
   double maxAbsNonzeroReal() const;
   ...
   void changeLhsReal(int i, const double& lhs);
   ...
   void changeLowerReal(int i, const double& lower);
   ...
   void changeUpperReal(int i, const double& upper);
   ...
   void changeBoundsReal(int i, const double& lower, const double& upper);
   ...
   void changeObjReal(int i, const double& obj);

   /// changes matrix entry in row \p i and column \p j to \p val
   void changeElementReal(int i, int j, const double& val);
   ...
   bool getBoundViolationReal(double& maxviol, double& sumviol);

   /// gets violation of constraints; returns true on success
   bool getRowViolationReal(double& maxviol, double& sumviol);

   /// gets violation of reduced costs; returns true on success
   bool getRedCostViolationReal(double& maxviol, double& sumviol);

   /// gets violation of dual multipliers; returns true on success
   bool getDualViolationReal(double& maxviol, double& sumviol);
   ...
   bool getEstimatedCondition(double& condition);

   /// computes the exact condition number for the current basis matrix using the power method; returns true on success
   bool getExactCondition(double& condition);

   /// computes row r of basis inverse; returns true on success
   bool getBasisInverseRowReal(int r, double* coef);

   /// computes column c of basis inverse; returns true on success
   bool getBasisInverseColReal(int c, double* coef);

   /// computes dense solution of basis matrix B * sol = rhs; returns true on success
   bool getBasisInverseTimesVecReal(double* rhs, double* sol);
   ...
   double realParam(const RealParam param) const;
   ...
   bool setRealParam(const RealParam param, const double value, const bool quiet = false, const bool init = false);
...
private:
   ...
   void _changeLhsReal(int i, const double& lhs);
   ...
   void _changeRhsReal(int i, const double& rhs);
   ...
   void _changeRangeReal(int i, const double& lhs, const double& rhs);
   ...
   void _changeLowerReal(int i, const double& lower);
   ...
   void _changeUpperReal(int i, const double& upper);
   ...
   void _changeBoundsReal(int i, const double& lower, const double& upper);

   /// changes matrix entry in row \p i and column \p j to \p val and adjusts basis
   void _changeElementReal(int i, int j, const double& val);
